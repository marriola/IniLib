...
namespace IniEditor
{
    public class MyMenuItemRenderer : ToolStripProfessionalRenderer
    {
        public MyMenuItemRenderer() : base(new MyMenuItemColors()) { }
    }

    public class MyMenuItemColors : ProfessionalColorTable
    {
        /// <summary>
