...
namespace IniLib.Wrappers
{
    public class KeyMapWrapper
    {
        ...
        internal KeyMapWrapper(Options options, Configuration.Configuration configuration, string sectionName, Configuration.KeyMap keyMap, Action<Configuration.Configuration> replaceState)
        {
            _options = options;
        ...
        /// <returns>A list of tuples of <see cref="string"/> and <see cref="IniLib.Node"/></returns>
        public List<Tuple<string, Node>> TryGetNodes(string keyName)
        {
            ...
            return _keyMap.Item[keyName].ToList();
        }
